			...
			<div className="container even-columns">
				...
				<nav className="secondary-navigation" aria-label="secondary">
					<ul className="even-columns small-gap" role="list">
						<li><a href="https://instagram.com"><i className="fa-brands fa-instagram" /></a></li>
						<li><a href="https://tiktok.com"><i className="fa-brands fa-tiktok" /></a></li>
						<li><a href="https://twitter.com"><i className="fa-brands fa-twitter" /></a></li>
